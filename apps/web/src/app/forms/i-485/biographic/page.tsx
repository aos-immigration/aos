      ...
      <div className="col-span-12 lg:col-span-8">
        <header className="mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl leading-relaxed">
            USCIS requires detailed biographical information for the applicant.
        ...
        <div className="mt-24 pt-8 border-t border-border flex items-center justify-between">
          <button className="flex items-center space-x-2 text-muted-foreground hover:text-foreground transition-colors group">
            ...
            <span className="text-sm font-medium">Previous: Address History</span>
          </button>
          <button className="flex items-center space-x-2 bg-foreground text-background px-6 py-2.5 rounded-lg text-sm font-bold hover:opacity-90 transition-all">
