...
import {
  ...
  type MailingAddressFormData,
} from "@/app/lib/schemas/addressSchema";
...
export function MailingAddressFormRHF({
  ...
  // Use a ref to access the latest address without triggering the effect loop
  ...
  // Handle state select specifically
